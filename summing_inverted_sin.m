function summing_inverted_sin(A1, f1, A2, f2, R, R1, R2)
...
'String', A1, ...
'Callback', 'A1 = str2num(get(gco,''string'')), close; summing_inverted_sin(A1, f1, A2, f2, R, R1, R2);');
...
'String', A2, ...
'Callback', 'A2 = str2num(get(gco,''string'')), close; summing_inverted_sin(A1, f1, A2, f2, R, R1, R2);');
...
'String', R, ...
'Callback', 'R = str2num(get(gco,''string'')), close; summing_inverted_sin(A1, f1, A2, R2, R, R1, R2);');
...
'String', R1, ...
'Callback', 'R1 = str2num(get(gco,''string'')), close; summing_inverted_sin(A1, f1, A2, f2, R, R1, R2);');
...
'String', R2, ...
'Callback', 'R2 = str2num(get(gco,''string'')), close; summing_inverted_sin(A1, f1, A2, f2, R, R1, R2);');
...
'string', 'RESET',...
'Callback', 'close; summing_inverted_sin(1, 100, 2, 100, 1e3, 1e3, 1e3);');
...
f1 = n;
set(kplot, 'ydata', -R * A1 * sin(2 * pi * f1 * t1) / R1 - R * A2 * sin(2 * pi * f2 * t2) / R2)
drawnow;
end
