function differential_sin(A1, f1, A2, f2, R1, R2, R3, R4)
...
'String', A1, ...
'Callback', 'A1 = str2num(get(gco,''string'')), close; differential_sin(A1, f1, A2, f2, R1, R2, R3, R4);');
...
'String', A2, ...
'Callback', 'A2 = str2num(get(gco,''string'')), close; differential_sin(A1, f1, A2, f2, R1, R2, R3, R4);');
...
'String', R1, ...
'Callback', 'R1 = str2num(get(gco,''string'')), close; differential_sin(A1, f1, A2, f2, R1, R2, R3, R4);');
...
'String', R2, ...
'Callback', 'R2 = str2num(get(gco,''string'')), close; differential_sin(A1, f1, A2, f2, R1, R2, R3, R4);');
...
'String', R3, ...
'Callback', 'R3 = str2num(get(gco,''string'')), close; differential_sin(A1, f1, A2, f2, R1, R2, R3, R4);');
...
'String', R4, ...
'Callback', 'R4 = str2num(get(gco,''string'')), close; differential_sin(A1, f1, A2, f2, R1, R2, R3, R4);');
...
'string', 'RESET',...
'Callback', 'close; differential_sin(1, 100, 2, 100, 1e3, 1e3, 1e3, 1e3);');
...
f1 = n;
set(kplot, 'ydata', (R4 / (R3 + R4)) * (1 + R2 / R1) * A1 * sin(2 * pi * f1 * t1) - R2 * A2 * sin(2 * pi * f2 * t1) / R1)
drawnow;
end
